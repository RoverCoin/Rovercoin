...
int nAnonymizeRoverAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Rover
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Rover
    // Mac: ~/Library/Application Support/Rover
    // Unix: ~/.Rover
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Rover";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Rover.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Roverd.pid"));
