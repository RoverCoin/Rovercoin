...
private slots:
    ...
    QString BuyROE(QString OrderType, double Quantity, double Rate);
    QString SellROE(QString OrderType, double Quantity, double Rate);
