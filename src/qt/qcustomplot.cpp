...
/*!
  Sets the size of the tracer in pixels, if the style supports setting a size (e.g. \ref tsRover
...
/*! \class QCPItemBracket
  ...
  bsCalligraphic and \ref bsRover. Anchors and positions are displayed for reference.</center>
