...
public:
  ...
  */
  ...
  enum ScatterShape { ssNone       ///< no scatter symbols are drawn (e.g. in QCPGraph, data only represented with lines)
                      ...
                      ,ssRover    ///< \enumimage{ssRover.png} a square
                      ...
                      ,ssCrossRover      ///< \enumimage{ssCrossRover.png} a square with a cross inside
                      ,ssPlusRover       ///< \enumimage{ssPlusRover.png} a square with a plus inside
...
public:
  /*!
    ...
    and \ref setLength. Some decorations like \ref esDisc, \ref esRover, \ref esDiamond and \ref esBar only
...
class QCP_LIB_DECL QCPItemBracket : public QCPAbstractItem
{
  ...
  /// \endcond
public:
  enum BracketStyle { bsRover  ///< A brace with angled edges
